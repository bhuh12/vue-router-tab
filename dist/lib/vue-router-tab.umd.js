...
/* harmony default export */ var operate = ({
  methods: {
    ...
    removeTab: function removeTab(id) {
      ...
      return operate_asyncToGenerator(
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee() {
        var items, idx;
        return regenerator_default.a.wrap(function _callee$(_context) {
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 13:
                ...
                if (to) {
                  ...
                  if (toRoute.fullPath === _this2.$route.fullPath) {
                    _this2.refreshTab();
                  } else {
...
/* harmony default export */ var RouterTab_scroll = ({
  ...
  watch: {
    activeTabId: function activeTabId() {
      ...
      return scroll_asyncToGenerator(
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee() {
...
var RouterTab = {
  ...
  destroyed: function destroyed() {
    // 取消原型挂载
    if (RouterTab.Vue.prototype.$routerTab === this) {
      RouterTab.Vue.prototype.$routerTab = null;
    }
  },
  methods: {
    // 初始页签数据
    ...
    // 页签是否可关闭
    isTabClosable: function isTabClosable(tab) {
    ...
    reloadView: function reloadView() {
      ...
      return RouterTab_vue_type_script_lang_js_asyncToGenerator(
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee() {
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
...
var component = normalizeComponent(
  ...
  RouterTabvue_type_template_id_39886bcf_render,
  staticRenderFns,
  false,
  null,
  null,
...
/* harmony default export */ var RouterTab_RouterTab = (component.exports);
...
// CONCATENATED MODULE: ./lib/page/Iframe.vue?vue&type=template&id=cd1f1e3e&
...
/* harmony default export */ var Iframevue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    ...
    return Iframevue_type_script_lang_js_asyncToGenerator(
    /*#__PURE__*/
    regenerator_default.a.mark(function _callee() {
...
var Iframe_component = normalizeComponent(
  ...
  Iframevue_type_template_id_cd1f1e3e_render,
  Iframevue_type_template_id_cd1f1e3e_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var lib = (RouterTab_RouterTab); // 路由
