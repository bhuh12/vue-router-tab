...
/* harmony default export */ var RouterTabvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    close: function close() {
      ...
      this.closeTabItem(id).then(function () {
        // 如果关闭当前页签，则打开后一个页签
        if (activedTab === id) {
    ...
    refreshAll: function refreshAll() {
      ...
      var promises = keys_default()(cache).map(function (id) {
        return function () {
          if (!force) {
            return _this7.pageLeavePromise(id, 'refresh').then(function () {
              $alive.clear(id);
            });
          } else {
            $alive.clear(id);
    ...
    // 重载路由组件
    reloadRouter: function reloadRouter() {
      var _this8 = this;
